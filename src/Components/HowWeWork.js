            ...
            <div className="container-fluid rubicFont EmergingBg " style={{paddingBottom: '4.5rem'}}>
                <div className="row border-top border-light px-3 text-start">
                    <div className="col-12  px-md-5 pt-5 pb-4 text-white">
                        ...
                        <p className='latoFont w-75 HowWeWorkDetails'>Following an initial screening, we will shortlist
                            a few companies and work with them for 90 days to completely assess them. In one of our 4
                            models, we onboard the businesses in the MARG'Om Studio.
                        </p><p className='latoFont w-75 HowWeWorkDetails'>Our mentors are guides as well as investors in
                        our accelerator, who will work closely with our portfolio firms. For a complete year, we will
                        collaborate with these businesses, helping them with technology, marketing, branding, finance,
                        governance, capability building, and expanding through growth enablers.
                    </p>
                    </div>
